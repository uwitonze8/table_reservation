...
export default function Navbar() {
  ...
  return (
    <nav className="bg-[#F8F4F0] shadow-md sticky top-0 z-50">
            ...
            {isLoggedIn ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 text-[#333333] hover:text-[#FF6B35] transition-colors font-medium"
                >
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className="text-left text-red-600 hover:text-red-700 transition-colors font-medium py-2 pl-4"
                  >
                    Logout
                  </button>
                  <div className="border-t border-gray-200 my-2"></div>
