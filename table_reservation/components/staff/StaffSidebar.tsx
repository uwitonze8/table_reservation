  ...
  const quickActions = [
    {
      ...
      onClick: () => console.log('Walk-in Guest'),
    },
    {
      name: 'View Tables',
      icon: (
    ...
    <aside className="w-64 bg-[#333333] h-screen p-6 flex flex-col fixed left-0 top-0 overflow-y-auto">
      ...
      <nav className="flex-1">
        ...
        <div className="mt-8 pt-6 border-t border-gray-700">
          <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3 px-4">Quick Actions</h3>
              ...
              if (action.href) {
                return (
                  <li key={index}>
                    <Link
                      href={action.href}
                      className="flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:bg-[#444444] hover:text-white rounded-lg transition-all"
                    >
                      <div className="text-[#FF6B35]">{action.icon}</div>
              ...
              return (
                <li key={index}>
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:bg-[#444444] hover:text-white rounded-lg transition-all"
                  >
                    <div className="text-[#FF6B35]">{action.icon}</div>
                    <span className="text-sm font-medium">{action.name}</span>
                  </button>
      ...
      <div className="border-t border-gray-700 pt-6 mt-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">{user?.staffId || 'Staff'}</p>
          </div>
        </div>
        <button
          onClick={logout}
